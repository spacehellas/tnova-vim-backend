...
routes = [{
  ...
  generateSingleMeasurementRoute('cpu_util',
  ...
  generateSingleMeasurementRoute('network_incoming',
    'Get the latest value of rate of incoming bytes on a specific instance'),
  generateSingleMeasurementRoute('network_outgoing',
    'Get the latest value of rate of incoming bytes on a specific instance'),
  generateSingleMeasurementRoute('load_shortterm',
    'Get the latest value of load average of the past one minute'),
  generateSingleMeasurementRoute('load_midterm',
    'Get the latest value of load average of the past five minutes'),
  generateSingleMeasurementRoute('load_longterm',
    'Get the latest value of load average of the past fifteen minutes'),
  generateSingleMeasurementRoute('processes_blocked',
    'Get the latest value of zombie processes'),
  generateSingleMeasurementRoute('processes_paging',
    'Get the latest value of zombie processes'),
  generateSingleMeasurementRoute('processes_running',
    'Get the latest value of zombie processes'),
  generateSingleMeasurementRoute('processes_sleeping',
    'Get the latest value of zombie processes'),
  generateSingleMeasurementRoute('processes_stopped',
    'Get the latest value of zombie processes'),
  generateSingleMeasurementRoute('processes_zombie',
    'Get the latest value of zombie processes')
];
